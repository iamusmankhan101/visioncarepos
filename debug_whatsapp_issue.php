<?php
// Debug WhatsApp notification issue
...
try {
    ...
    echo "<h3>Step 3: Manual notification test</h3>";
    
    if ($transaction && $contact && !empty($contact->mobile)) {
        // Test the notification manually
        $notificationUtil = new \App\Utils\NotificationUtil();
        
        echo "<p>Testing 'order_ready' notification...</p>";
        ...
        if ($whatsapp_link) {
            echo "<p style='color: green;'>✅ <strong>SUCCESS!</strong> WhatsApp link generated:</p>";
            echo "<p><a href='$whatsapp_link' target='_blank'>$whatsapp_link</a></p>";
        } else {
            echo "<p style='color: red;'>❌ No WhatsApp link generated</p>";
        }
    }
    
    echo "<hr>";
    echo "<h3>✅ Summary</h3>";
    echo "<p>If templates were created and you have a mobile number, WhatsApp notifications should now work.</p>";
