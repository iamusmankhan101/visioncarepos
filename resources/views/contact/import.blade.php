    ...
    <div class="row">
        <div class="col-sm-12">
            @component('components.widget', ['class' => 'box-primary'])
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group">
                                ...
                                {!! Form::file('contacts_csv', ['accept'=> '.xls,.xlsx,.csv', 'required' => 'required']); !!}
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <a href="{{ asset('files/import_contacts_csv_template.xls') }}?v={{ time() }}" class="tw-dw-btn tw-dw-btn-success tw-text-white" download><i class="fa fa-download"></i> @lang('lang_v1.download_template_file')</a>
                    </div>
                </div>
            @endcomponent
        </div>
        ...
        <div class="col-sm-12">
            @component('components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.instructions')])
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        <td>29</td>
                        <td>{{ $custom_labels['contact']['custom_field_6'] ?? __('lang_v1.contact_custom_field6') }} <small class="text-muted">(@lang('lang_v1.optional'))</small></td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        <td>30</td>
                        <td>{{ $custom_labels['contact']['custom_field_7'] ?? __('lang_v1.contact_custom_field7') }} <small class="text-muted">(@lang('lang_v1.optional'))</small></td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        <td>31</td>
                        <td>{{ $custom_labels['contact']['custom_field_8'] ?? __('lang_v1.contact_custom_field8') }} <small class="text-muted">(@lang('lang_v1.optional'))</small></td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        <td>32</td>
