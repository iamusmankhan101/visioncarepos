            ...
            @if (auth()->user()->can('supplier.create') ||
                ...
                @slot('tool')
                    <div class="box-tools">
                        ...
                        <button type="button" 
                           class="tw-dw-btn tw-bg-gradient-to-r tw-from-green-600 tw-to-green-500 tw-font-bold tw-text-white tw-border-none tw-rounded-full tw-mr-2" 
                           id="export_for_import_btn">
...
@section('javascript')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#export_for_import_btn').on('click', function() {
                var selectedIds = [];
                $('.customer_checkbox:checked').each(function() {
                    selectedIds.push($(this).val());
                });
                ...
                var url = '/contacts/export-for-import?type=' + contactType;
