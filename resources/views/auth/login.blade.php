            ...
            <div
                ...
                <div class="tw-flex tw-flex-col tw-gap-4 tw-dw-rounded-box tw-dw-p-6 tw-dw-max-w-md">
                    ...
                    <form method="POST" action="{{ route('login') }}" id="login-form">
                                ...
                                <div class="tw-dw-label">
                                    ...
                                    @if (config('app.env') != 'demo')
                                        <a href="{{ route('password.request') }}"
                                            class="tw-text-xs md:tw-text-sm tw-font-medium hover:tw-underline" style="color: #48b2ee;"
                        ...
                        @endif
                        <button type="submit"
                            class="tw-h-12 tw-rounded-xl tw-text-sm md:tw-text-base tw-text-white tw-font-semibold tw-w-full tw-max-w-full mt-2 hover:tw-opacity-90 focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-offset-2 active:tw-opacity-80" style="background-color: #48b2ee; box-shadow: 0 4px 6px -1px rgba(72, 178, 238, 0.3);">
                            @lang('lang_v1.login')
                        </button>
                    </form>
