...
@section('content')
    ...
    <!-- Order Status Modal Container for Shipments -->
        ...
        $(document).ready(function() {
            ...
            sell_table = $('#shipments_table').DataTable({
                ...
                "fnDrawCallback": function(oSettings) {
                    ...
                    console.log('Shipments table redrawn, attaching order status handlers...');
                    ...
                    // Use event delegation to handle dynamically added buttons in shipments table
                    $('#shipments_table').off('click', '.quick-order-status-btn').on('click', '.quick-order-status-btn', function(e) {
                        e.preventDefault();
                        e.stopPropagation();
                        ...
                        console.log('🎯 Shipments order status button clicked');
                        console.log('URL:', url);
                    ...
                    var buttonCount = $('#shipments_table .quick-order-status-btn').length;
                    console.log('📊 Found', buttonCount, 'order status buttons in shipments table after redraw');
                },
