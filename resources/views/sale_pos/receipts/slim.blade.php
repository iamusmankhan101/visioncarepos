    ...
    <body>
        <div class="ticket">
			...
			<div style="page-break-inside: avoid; margin-top: 20px;">
				...
				<div style="padding: 15px; font-size: 11px; text-align: center; background-color: #f0f0f0; border: 2px solid #000;">
					<strong style="font-size: 13px;">TERMS & CONDITIONS</strong><br><br>
