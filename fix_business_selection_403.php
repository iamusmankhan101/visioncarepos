...
try {
    ...
    // Step 5: Ensure SellPosController has create method
    echo "<h3>Step 5: Controller Method Check</h3>";
    $controller = new \App\Http\Controllers\SellPosController();
    if (!method_exists($controller, 'create')) {
        echo "❌ create method missing in SellPosController. Adding it...<br>";
        
        // Read current controller
        $controllerPath = 'app/Http/Controllers/SellPosController.php';
        $content = file_get_contents($controllerPath);
        
        // Add create method if it doesn't exist
...
';
    ...
    // Step 6: Clear cache
    echo "<h3>Step 6: Cache Management</h3>";
    try {
