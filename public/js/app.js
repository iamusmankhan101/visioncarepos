$(document).ready(function () {
    ...
    if (contact_table_type == 'supplier') {
        var columns = [
            ...
            { data: 'tax_number', name: 'contacts.tax_number' },
            { data: 'pay_term', name: 'contacts.pay_term', searchable: false, orderable: false },
            { data: 'opening_balance', name: 'contacts.opening_balance', searchable: false },
            { data: 'balance', name: 'contacts.balance', searchable: false },
            ...
            { data: 'custom_field2', name: 'contacts.custom_field2' },
            { data: 'custom_field3', name: 'contacts.custom_field3' },
            { data: 'custom_field4', name: 'contacts.custom_field4' },
            { data: 'custom_field5', name: 'contacts.custom_field5' },
            { data: 'custom_field6', name: 'contacts.custom_field6' },
            { data: 'custom_field7', name: 'contacts.custom_field7' },
