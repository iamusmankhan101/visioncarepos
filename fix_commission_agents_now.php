...
// Quick fix for commission agents showing N/A values
...
// 1. Check current commission agents
...
if (count($agents) == 0) {
    echo "2. Creating sample commission agents:\n";
    ...
    echo "2. Fixing existing agents with empty names:\n";
...
// 3. Create some sample sales for testing
echo "\n3. Creating sample sales for commission calculation:\n";
...
echo "Now check your dashboard - the Sales Commission section should show proper data.\n";
